...
\hypertarget{welconing-facilitaor}{%
\chapter{Welconing Facilitaor}\label{welconing-facilitaor}}
...
\begin{itemize}
\item
  \textbf{Read} \href{https://twu.idm.oclc.org/login?url=https://search.ebscohost.com/login.aspx?direct=true\&db=edselp\&AN=S2405844022008684\&site=eds-live\&scope=site}{Motivation as a facilitator of self-leadership in nurse academics}\\
\item
\item
  \href{https://twu.idm.oclc.org/login?url=https://search.ebscohost.com/login.aspx?direct=true\&db=ccm\&AN=151058677\&site=eds-live\&scope=site}{Spanish-Speaking Parents' Experiences Accessing Academic Medical Center Care: Barriers, Facilitators and Technology Use.}
\item
  ** Watch **
\item
\end{itemize}
...
\hypertarget{topic-1-title-1}{%
\section{Topic 1 Title}\label{topic-1-title-1}}

{[}Add content{]}

\includegraphics{assets/sample/crow.jpg}

\hypertarget{activity-introductory-readings-video-1}{%
\subsection*{Activity: Introductory Readings \& Video}\label{activity-introductory-readings-video-1}}
\addcontentsline{toc}{subsection}{Activity: Introductory Readings \& Video}
...
\hypertarget{topic-2-title-1}{%
\section{Topic 2 Title}\label{topic-2-title-1}}

{[}add content{]}

\hypertarget{topic-3-title-1}{%
\section{Topic 3 Title}\label{topic-3-title-1}}
